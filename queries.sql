...
INSERT INTO tasks (title, description, status_id, user_id) VALUES ('New task for test', 'task for task run', 1, 1);
...
UPDATE users SET fullname = "ssssss Oppsich" WHERE id = 1;
